...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl" xmlns:hl7="urn:hl7-org:v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns="http://www.w3.org/1999/xhtml" exclude-result-prefixes="xd hl7 xsi xhtml" version="1.0">
    <xd:doc scope="stylesheet">
        <xd:desc>
            ...
            <xd:p><xd:b>Adapted and maintained by:</xd:b> Alexander Henket, Nictiz, The Netherlands, henket(a)nictiz.nl / Dr. Kai U. Heitmann, HL7 Germany, kai(at)hl7.de</xd:p>
    ...
    <xd:doc>
        <xd:desc>
            <xd:p>Section numbers. When set to true() sections are numbered (preceded by section numbers)</xd:p>
        </xd:desc>
    </xd:doc>
    <xsl:param name="sectionnumbers" select="false()"/>
    ...
    <xsl:template name="formatDateTime">
        ...
        <xsl:choose>
            ...
            <xsl:when test="$textLangPartLowerCase='de'">
                <xsl:value-of select="$dayNum"/>
                <xsl:text>. </xsl:text>
                <xsl:call-template name="firstCharCaseUp">
                    <xsl:with-param name="data" select="$monthText"/>
